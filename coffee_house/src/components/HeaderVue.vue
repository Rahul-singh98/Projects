<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="height: 100px;">
    <div class="container-fluid mx-5">
      <!-- <a class="navbar-brand" href="#"><img src="./../assets/coffelogo.jpg" alt="logo"
          style="height: 100px; width: 100px; border-radius: 10px;"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-3">
          <li class="nav-item">
            <router-link to="/"><a class="nav-link fs-4 text-decoration-none">Menu</a></router-link>
          </li>
          <li class="nav-item">
            <a class="nav-link fs-4" href="#">Rewards</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fs-4" href="#">GiftCards</a>
          </li>
          <li class="nav-item">
            <router-link to="/about"><a class="nav-link fs-4 text-decoration-none">About Us</a></router-link>
          </li>
        </ul>
        <form class="d-flex">
          <button class="btn btn-outline-success mx-2" type="signup">Sign in</button>
          <button class="btn btn-success" type="login">join now</button>
        </form>
      </div> -->
      ...
      <div class="row">
        <div class="tm-top-header-inner">
          <div class="tm-logo-container">
            <img src="../assets/logo.png" alt="Logo" class="tm-site-logo">
